							...
							cb(err,null);
								...
								if(rows.length)
									cb(null,rows);
										...
										let err={myError:'no rows for chat id '+obj.chatid+'and userid '+obj.userid};
										cb(err,null);	
								}
						}
							...
							cb(err,null);
								...
								if(rows.length)
									cb(null,rows);
										...
										let err={myError:'no rows for user id '+userid};
										cb(err,null);	
								}
						}
							...
							cb(err,null);
								...
								if(rows.length)
									cb(null,rows);
										...
										let err={myError:'no rows for chat id '+chatid};
										cb(err,null);	
								}
						}
